...
export type VendorTextKey = keyof typeof en
...
export function t(key: VendorTextKey, values: Record<string, string | number> = {}): string {
  return i18next.t(key, { ns: 'vendor', ...values })
}
